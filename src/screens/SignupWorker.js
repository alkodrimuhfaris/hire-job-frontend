...
import { Image, StyleSheet, View, StatusBar, ScrollView, TextInput, TouchableOpacity } from 'react-native';
import { Button, Text, Container, Content, Title, Card, CardItem, Form, Label } from 'native-base';
                                ...
                                <View style={styles.register}>
                                    <Form>
                                        ...
                                        <View style={styles.linkLogin}>
                                            <Text style={styles.textSign}>Already have a account? </Text>
                                            <TouchableOpacity>
