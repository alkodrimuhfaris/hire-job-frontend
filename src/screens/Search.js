...
import { Container, Content, Form, Item, Input, List, ListItem } from 'native-base';
        ...
        <Content >
          <Form style={styles.form}>
            <Item regular style={styles.searcInput}>
              <TouchableOpacity style={styles.searchIcon} onPress={() => navigation.navigate('ResultSearch')}>
              <SearchIcon  />
              </TouchableOpacity>
              <Input style={styles.placeholder} placeholder="Android developer"
...
const styles = StyleSheet.create({
  ...
  searcInput: {
    position:'relative',width: 280, height: 50, marginLeft: 26, marginTop: 70, borderRadius: 4, backgroundColor: '#ffff'
  },
  placeholder: { paddingLeft: 47, color: '#9EA0A5', fontSize: 14 },
  filter: { width: 53, height: 50, marginTop: 70, marginLeft: 10, borderRadius: 4, backgroundColor: '#ffff' },
  ...
  child:{borderBottomColor:'gray',width:'100%',paddingLeft:25,paddingTop:20,paddingBottom:20}
});
