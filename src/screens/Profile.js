            ...
            <ScrollView>
                <Card style={styles.cardUp} transparent>
                    <View style={styles.parent}>
                        ...
                        <Text style={styles.desc}>You asked, Font Awesome delivers with 41 shiny new icons in version 4.7. Want to request new icons? Here's how. Need vectors or want to use on the desktop? Check the cheatsheet.</Text>
